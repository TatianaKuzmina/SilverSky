...
import com.example.silversky.repositories.CartRepository;
import com.example.silversky.repositories.OrderRepository;
import com.example.silversky.repositories.ProductRepository;
import com.example.silversky.security.PersonDetails;
import com.example.silversky.services.PersonService;
import com.example.silversky.services.ProductService;
import com.example.silversky.util.PersonValidator;
...
// - MainController отвечает за аутентифицированного пользователя
@Controller
...
//    }
    ...
    public String productSearch(@RequestParam("search") String search, @RequestParam("ot") String ot, @RequestParam("do") String Do, @RequestParam(value = "price", required = false, defaultValue = "") String price, @RequestParam(value = "contract", required = false, defaultValue = "")String contract, Model model){
        ...
        return "/user/index"; // - было так "/product/product"
